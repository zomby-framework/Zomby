...
public class Geo {
	...
	/**
	 * simulate a going walker with 6 km/h who goes from start- to end point<br>
	 ...
	 */
	public void simulateGoingWalker(final double startPointLongitude, final double startPointLatitude, 
	...
	/**
	 * simulate a running man with 15 km/h who goes from start- to end point<br>
	 * NOTE: method runs in a new thread
	 * @param startLongitude
	 * @param startLatitude
	 * @param endPointLongitude
	 * @param endPointLatitude
	 */
	public void simulateRunningMan(final double startPointLongitude, final double startPointLatitude, 
			final double endPointLongitude, final double endPointLatitude) {
