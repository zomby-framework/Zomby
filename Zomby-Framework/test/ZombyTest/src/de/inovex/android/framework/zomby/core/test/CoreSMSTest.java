 ...
 *
 */
public class CoreSMSTest extends ActivityInstrumentationTestCase2<ZombyRecorderActivity> {
	
	private Solo solo;
	String phonenumber = "01223";
	String message = "Hello Zomby!";
	...
	public void testSend() throws Exception {
		Zomby.getCoreSMS().send(phonenumber, message);
	}

	public void testPdu() throws Exception {
		Zomby.getCoreSMS().pdu(message);
	}
}
