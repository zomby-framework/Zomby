 ...
 *
 */
public class AVDTest extends ActivityInstrumentationTestCase2<ZombyRecorderActivity> {
	...
	public void testStartAVD() throws Exception {
		Zomby.getAVD().startAVD();
	}

	public void testStopAVD() throws Exception {
		Zomby.getAVD().stopAVD();
	}
}
